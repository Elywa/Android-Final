package com.example.androidproject.data.dto.table;
...
public class Dinner implements Parcelable {
    ...
    public Meal dinnerToMealMapper()
    {
    ...
    public static final Creator<Dinner> CREATOR = new Creator<Dinner>() {
        @Override
        public Dinner createFromParcel(Parcel in) {
            return new Dinner(in);
        }
