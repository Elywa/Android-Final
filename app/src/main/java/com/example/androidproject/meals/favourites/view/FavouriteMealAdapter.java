...
public class FavouriteMealAdapter  extends RecyclerView.Adapter<FavouriteMealAdapter.CalenderMealViewHolder> {
    ...
    @NonNull
    @Override
    public FavouriteMealAdapter.CalenderMealViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FavouriteMealAdapter.CalenderMealViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.favourite_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull FavouriteMealAdapter.CalenderMealViewHolder holder, int position) {
